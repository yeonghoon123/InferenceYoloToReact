...
def display(preds, imgs, num, fn_path, imshow=True, imwrite=False):
...
if __name__ == '__main__':
    ...
    for i, fn_path in enumerate(test_dataset):
        ori_imgs, framed_imgs, framed_metas = preprocess(fn_path, max_size=input_size)
        ...
        with torch.no_grad():
            features, regression, classification, anchors = model(x) # 모델 수행 부분
        ...
        display(out, [ori_imgs[0][:, :, ::-1]],i,fn_path, imshow=False, imwrite=True)
